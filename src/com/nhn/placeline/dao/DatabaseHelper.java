...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void initDB(SQLiteDatabase db) {
		...
		//picture
		db.execSQL("insert into pinIdToPicture(pinId, picture) value('1', '"+R.drawable.photo_1+"')");
		db.execSQL("insert into pinIdToPicture(pinId, picture) value('1', '"+R.drawable.photo_2+"')");
		db.execSQL("insert into pinIdToPicture(pinId, picture) value('1', '"+R.drawable.photo_3+"')");
		db.execSQL("insert into pinIdToPicture(pinId, picture) value('1', '"+R.drawable.photo_4+"')");
